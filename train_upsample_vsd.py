...
from model.trainer_upsample_vsd import TrainerUpsampleVSD
...
def train(cfg: DictConfig):
    ...
    teacher_diffusion_model = instantiate_from_config(configs.model).cuda()
    student_diffusion_model = instantiate_from_config(configs.model).cuda()
    ...
    trainer = TrainerUpsampleVSD(
                        reconstructor=reconstructor,
                        teacher_model=teacher_diffusion_model,
                        student_model=student_diffusion_model,
                        accelerator=accelerator,
                        train_dataloader=train_dataloader,
                        val_dataloader=val_dataloader,
                        train_batch_size=train_batch_size,
                        train_lr= cfg.lr,
                        train_student_lr= cfg.student_lr,
