...
from model.wrapper import DeterministicWrapper
from model.trainer_deterministic import TrainerDeterministic
import torch
...
def train(cfg: DictConfig):
    ...
    reconstructor   = DeterministicWrapper(reconstructor, cfg=cfg).cuda()
    
    print(f"using lr= {cfg.lr}")
    print(f"logging at {logdir}")

    trainer = TrainerDeterministic(
