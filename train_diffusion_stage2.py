...
from model.trainer_diffusion_stage2 import TrainerDiffusionStage2
import torch
...
def train(cfg: DictConfig):
    ...
    val_dataset = get_data_manager(cfg, cfg.data.category[0], "val" if cfg.data.dataset_type == "srn" else "test")
    ...
    trainer = TrainerDiffusionStage2(
