...
def run_map():
    ...
    def process_obj(path, rend_path, metricator):
    ...
    for obj_path, obj_rend_path in tqdm(all_objs):
        psnr, ssim, lpips, num_im = process_obj(obj_path, obj_rend_path, metricator)
    ...
    print(f"PSNR: {all_psnr/num_ims}")
    print(f"SSIM: {all_ssim/num_ims}")
    print(f"LPIPS: {all_lpips/num_ims}")
